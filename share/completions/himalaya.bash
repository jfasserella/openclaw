_himalaya() {
    ...
    case "${cmd}" in
        himalaya)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version account folder mailbox envelope flag message attachment template manual completion help"
            ...
            ;;
        himalaya__account)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version configure doctor list help"
        ...
        himalaya__account__configure)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version <ACCOUNT>"
        ...
        himalaya__account__doctor)
            opts="-f -c -o -h -V --fix --config --output --quiet --debug --trace --help --version [ACCOUNT]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__account__list)
            opts="-w -c -o -h -V --max-width --config --output --quiet --debug --trace --help --version"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__attachment)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version download help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__attachment__download)
            opts="-f -a -d -c -o -h -V --folder --account --downloads-dir --config --output --quiet --debug --trace --help --version <ID>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__completion)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version bash elvish fish powershell zsh"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        himalaya__envelope)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version list thread help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__envelope__list)
            opts="-f -p -s -a -w -c -o -h -V --folder --page --page-size --account --max-width --config --output --quiet --debug --trace --help --version [QUERY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__envelope__thread)
            opts="-f -a -i -c -o -h -V --folder --account --id --config --output --quiet --debug --trace --help --version [QUERY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        himalaya__flag)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version add set remove help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        himalaya__flag__add)
            opts="-f -a -c -o -h -V --folder --account --config --output --quiet --debug --trace --help --version <ID-OR-FLAG>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__flag__set)
            ...
            ;;
        himalaya__folder)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version add create list expunge purge delete help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__folder__add)
            opts="-a -c -o -h -V --account --config --output --quiet --debug --trace --help --version <FOLDER>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__folder__delete)
            opts="-a -y -c -o -h -V --account --yes --config --output --quiet --debug --trace --help --version <FOLDER>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__folder__list)
            opts="-a -w -c -o -h -V --account --max-width --config --output --quiet --debug --trace --help --version"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__help__template__write)
            ...
            ;;
        himalaya__manual)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version <DIR>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        himalaya__message)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version read export thread write reply forward edit mailto save send copy move delete help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__copy)
            opts="-f -a -c -o -h -V --folder --account --config --output --quiet --debug --trace --help --version <TARGET> <ID>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__delete)
            opts="-f -a -c -o -h -V --folder --account --config --output --quiet --debug --trace --help --version <ID>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__edit)
            opts="-f -H -p -a -c -o -h -V --folder --header --on-place --account --config --output --quiet --debug --trace --help --version <ID>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__export)
            opts="-f -F -O -d -a -c -o -h -V --folder --full --open --destination --account --config --output --quiet --debug --trace --help --version <ID>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__forward)
            opts="-f -H -a -c -o -h -V --folder --header --account --config --output --quiet --debug --trace --help --version <ID> [BODY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__mailto)
            opts="-a -c -o -h -V --account --config --output --quiet --debug --trace --help --version <URL>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__read)
            opts="-f -p -H -a -c -o -h -V --folder --preview --no-headers --header --account --config --output --quiet --debug --trace --help --version <ID>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__reply)
            opts="-f -A -H -a -c -o -h -V --folder --all --header --account --config --output --quiet --debug --trace --help --version <ID> [BODY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__save)
            opts="-f -a -c -o -h -V --folder --account --config --output --quiet --debug --trace --help --version [MESSAGE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__send)
            opts="-a -c -o -h -V --account --config --output --quiet --debug --trace --help --version [MESSAGE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__message__write)
            opts="-H -a -c -o -h -V --header --account --config --output --quiet --debug --trace --help --version [BODY]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        himalaya__template)
            opts="-c -o -h -V --config --output --quiet --debug --trace --help --version write reply forward save send help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__template__save)
            opts="-f -a -c -o -h -V --folder --account --config --output --quiet --debug --trace --help --version [TEMPLATE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        himalaya__template__send)
            opts="-a -c -o -h -V --account --config --output --quiet --debug --trace --help --version [TEMPLATE]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
